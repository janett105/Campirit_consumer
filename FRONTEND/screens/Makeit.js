...
const App = ({ route , navigation }) => {
  ...
  const Selete_box = (props) =>{
    ...
    <View style={styles.selete_box}>
        <Image source={require("./assets/images/MarketkitTent/retangle.png")} style={styles.footer_selate_img}/>
          <View style={{left:10}}>
...
return (
  <SafeAreaView>
    <View style={styles.header}>
      <Image source={require("./assets/images/MarketkitTent/tent.png")} style={{marginTop:12}}/>
  ...
  <Image source={require("./assets/images/MarketkitTent/Top_line.png")}/>
    

  <ScrollView pagingEnabled style={styles.Content_list} horizontal = {true}>  
    <Image source={require("./assets/images/MarketkitTent/retangle.png")} style={styles.Content_image}/>
    ...
    <View style={{flexDirection: 'row'}} >
     <Image source={require("./assets/images/MarketkitTent/slid_button.png")} style={{marginTop:17, height:100}}/>
